...
% *
% * The `RunSim` function initializes the simulation environment by creating the user interface,
...
% */
function RunSim
    % RunSim sets up the UI, runs vehicle simulations, and plots results.
