classdef SpeedController < handle
    ...
    %
    %   Usage:
    %       controller = SpeedController(desiredSpeed, maxSpeed, Kp, Ki, Kd, ...
    ...
    methods
        %% Constructor
        function obj = SpeedController(desiredSpeed, maxSpeed, Kp, Ki, Kd, ...
            ...
            if obj.verbose
                fprintf('SpeedController initialized with cornering safety.\n');
            end
        end
        ...
        function acceleration = computeAcceleration(obj, currentSpeed, currentTime, turnRadius)
            ...
            if corneringSpeed < obj.desiredSpeed
                ...
                if obj.verbose
                    fprintf('[SpeedController] Reducing desired speed to %.2f m/s due to turn radius = %.2f m\n',...
            ...
            if filteredSpeed > obj.desiredSpeed
                ...
                acceleration = 0;
                if obj.verbose
                    fprintf('[SpeedController] Deceleration needed. Controller set to 0.\n');
                end
                return;
            else
                % Re-enable controller if not active
                if ~obj.controllerActive && obj.verbose
                    fprintf('[SpeedController] Re-enabling controller.\n');
                end
                obj.controllerActive = true;
            end
            ...
            if obj.desiredSpeed <= 0
                ...
                obj.controllerActive = false;
                if obj.verbose
                    fprintf('[SpeedController] Desired speed <= 0. Controller disabled.\n');
                end
                return;
            end
            ...
            if acceleration < 0
                ...
                acceleration = 0;
                if obj.verbose
                    fprintf('[SpeedController] Negative accel => letting brakes handle deceleration.\n');
                end
            end
        end
        ...
        function reset(obj)
            ...
            if obj.verbose
                fprintf('[SpeedController] Reset and re-enabled.\n');
            end
        end
    end
end
